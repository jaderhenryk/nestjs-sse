...
## Deploying the docker containers and accessing the app container

It`s needed to have Docker installed in your machine.
...
Run `npx prisma migrate dev` to create your database and tables.
